...
def wordle_end_geraden():
    ...
    return render_template("Games/End.html",game="Wordle", beschrijving="Proficiat u wist de lingo "+ woord + " op te lossen!", background_source=background_source, href="/Wordle")
...
def wordle_end_N_geraden():
    ...
    return render_template("Games/End.html",game="Wordle", beschrijving="Spijtig u de lingo "+ woord + " niet op te lossen!", background_source=background_source, href="/Wordle")